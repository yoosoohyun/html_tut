...
/*
  ...
  객체( Object ) : 하나의 독립된 속성( 가지고 있는 것, 정적인 것 ), 기능( 동적인 것 )을 할 수 있는 대상
  ...
  2. 코딩에서의 객체
      ...
      객체의 Property와 Method는 해당 객체의 전용으로 사용 됨
...
(function(){
  ...
  /*
    전역 변수 사용하는 것 처럼 사용하지 않고, 지역변수와 매개변수를 사용하는 방법으로 사용할 수 있도록 객체를 설계해야 함.
...
(function(){
 ...
 // 객체 Property에 객체 내부에서의 접근 외에 다른 곳에서 직접 접근하는 것을 막지는 못 함. => 막기 위해서는 다른 방법을 사용해야 함
